...
public class ArtfulWallEntity extends net.minecraft.entity.mob.PathAwareEntity implements GeoAnimatable {
    ...
    public ArtfulWallEntity(EntityType<? extends PathAwareEntity> entityType, World world) {
